...
public class ClientConfig {
	...
	static {
		...
		ADDITIONAL_BLUEPRINT_FOLDERS = BUILDER.comment("Additional paths that are aviable in the commands via their names.").defineList("aditional_folders", (List<String>) Arrays.asList("world:/saves/" + WORLD_FOLDER_KEY + "/generated/minecraft/structures", "worldedit:/config/worldedit/schematics"), s -> true);
